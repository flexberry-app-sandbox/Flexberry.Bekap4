...
namespace IIS.Bekap_4
{
    ...
    public class Визит : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Bekap_4.Клиент fКлиент;
        
        private IIS.Bekap_4.DetailArrayOfЗаписьВизита fЗаписьВизита;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Bekap_4.Клиент Клиент
        {
            get
            {
                ...
                IIS.Bekap_4.Клиент result = this.fКлиент;
        ...
        public virtual IIS.Bekap_4.DetailArrayOfЗаписьВизита ЗаписьВизита
        {
            get
            {
                ...
                {
                    this.fЗаписьВизита = new IIS.Bekap_4.DetailArrayOfЗаписьВизита(this);
                }
                IIS.Bekap_4.DetailArrayOfЗаписьВизита result = this.fЗаписьВизита;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВизитE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВизитE", typeof(IIS.Bekap_4.Визит));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВизитL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВизитL", typeof(IIS.Bekap_4.Визит));
                }
            }
        }
    }
