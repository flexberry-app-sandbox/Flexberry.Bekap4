...
namespace IIS.Bekap_4
{
    ...
    public class сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Bekap_4.Должности fДолжности;
        ...
        public virtual IIS.Bekap_4.Пол Пол
        {
            get
            {
                ...
                IIS.Bekap_4.Пол result = this.fПол;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Bekap_4.Должности Должности
        {
            get
            {
                ...
                IIS.Bekap_4.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View сотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("сотрудникE", typeof(IIS.Bekap_4.сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View сотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("сотрудникL", typeof(IIS.Bekap_4.сотрудник));
                }
            }
        }
    }
